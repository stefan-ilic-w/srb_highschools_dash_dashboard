...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:stefan-db.database.windows.net,1433;Database=srednja_edu;Uid=stefanilic;Pwd=Microlemon01!;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
